...
using CM.SendBrick.Library.BrickLink;
using System;
...
namespace CM.SendBrick.Library.BrickLink.Tests
{
    [TestClass()]
    public class BrickLinkComsTests
    {
        [TestMethod()]
        public void ReadJsonTest()
        {
            ...
            //BrickLinkComs.ReadJson(testItem, testJson);
